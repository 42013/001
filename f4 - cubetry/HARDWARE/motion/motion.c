...
int U1coordinate(char step)//center1
{
   ...
   while(stage==0&&Step=='1'){
	  cubesolve1(step,9,9,14); //9，9，14
   }
   
   
   while(stage==0&&Step=='2'){
	   cubesolve2(step,24,19,24); //24,19,24
   }
   
   while(stage==0&&Step=='3'){
	   cubesolve3(step,7,7,7); //7,7,7
   }
   
   while(stage==0&&Step=='4'){
	   cubesolve4(step,5,5,5); //5,5,5
   }
   
   while(stage==0&&Step=='5'){
	   cubesolve5(step,1,1,1); //1,1,1
   }
   
   while(stage==0&&Step=='6'){
	   cubesolve6(step,1,1,1); //1,1,1
   }
	return center;	
}
...
int U2coordinate(char step)//center2
{
  if(stage==-1){
   ...
   while(stage==0&&Step=='1'){
	   cubesolve1(step,21,21,10); //21，21，10
   }
   
   
   while(stage==0&&Step=='2'){
	   cubesolve2(step,20,15,20); //20，15，20
   }
   
   while(stage==0&&Step=='3'){
	   cubesolve4(step,8,8,8); //8，8，8
   }
   
   while(stage==0&&Step=='4'){
	   cubesolve5(step,2,2,2); //2，2，2
   }
   
   while(stage==0&&Step=='5'){
	   cubesolve6(step,2,2,2); //2，2，2
   }
   
   while(stage==0&&Step=='6'){
	   cubesolve3(step,6,6,6); //2，2，2
   }
	return center;	
}
...
int U3coordinate(char step)//center3
{
   ...
   while(stage==0&&Step=='1'){
	    cubesolve1(step,17,17,22); //17，17，22
   }
   
   
   while(stage==0&&Step=='2'){
	    cubesolve2(step,16,11,16); //16，11，16
   }
   
   while(stage==0&&Step=='3'){
	   cubesolve5(step,3,3,3); //3，3，3
   }
   
   while(stage==0&&Step=='4'){
	   cubesolve6(step,3,3,3); //3，3，3
   }
   
   while(stage==0&&Step=='5'){
	   cubesolve3(step,5,5,5); //5，5，5
   }
   
   while(stage==0&&Step=='6'){
	   cubesolve4(step,7,7,7); //7，7，7
   }
	return center;	
}
...
int U4coordinate(char step)//center4
{
   ...
   while(stage==0&&Step=='1'){
	   cubesolve1(step,13,13,18); //13，13，18
   }
   
   
   while(stage==0&&Step=='2'){
	   cubesolve2(step,12,23,12); //12，23，12
   }
   
   while(stage==0&&Step=='3'){
	   cubesolve6(step,4,4,4); //4，4，4
   }
   
   while(stage==0&&Step=='4'){
	   cubesolve3(step,8,8,8); //8，8，8
   }
   
   while(stage==0&&Step=='5'){
	   cubesolve4(step,6,6,6); //6，6，6
   }
   
   while(stage==0&&Step=='6'){
	   cubesolve5(step,4,4,4); //4, 4, 4
   }
	return center;	
}
